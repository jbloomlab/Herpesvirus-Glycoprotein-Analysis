...
Entrez.email = "EBVexample@EBVexample.com"     # Always tell NCBI who you are
    ...
    with open(input_file_name, "r") as input_file:
        for line in input_file:
            ...
            for line in entrez_genbank:
                ...
                if desired_gene != None and ("/product" in line or "/gene" in line or "/note" in line) and curr_CDS and gene != desired_gene:
                ...
                if features_flag == True:
                    ...
                    if "/organism" in line:
                        virus = line.replace("\n", "").replace("\"", "").split("=")[1]
                        if virus.lower() == "human gammaherpesvirus 4":
                            virus = "Human gammaherpesvirus 4"
                    if "/host" in line:
                        host = line.replace("\n", "").replace("\"", "").split("=")[1]
                        if host == "Homo sapiens; male" or host == "Homo sapiens; female":
                            host = "Homo sapiens"
