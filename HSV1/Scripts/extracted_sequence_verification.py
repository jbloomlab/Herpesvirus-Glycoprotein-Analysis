...
def assert_num_orfs_match_sequences(
    ...
    if verification_flag:
        ...
        output_log_file.write("All sequences confirmed to have one-to-one ORF mappings!\n")
        output_log_file.write(f"From {len(segment_list)} sequences, {len(protein_list)} ORFs found!")
        # Close files
