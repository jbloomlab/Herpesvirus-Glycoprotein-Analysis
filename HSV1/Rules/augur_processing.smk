...
rule root_and_remove_outgroup:
    ...
    input:
        ...
        codon_alignment = "Results/{gene}/Alignments/codon.fasta",
    output:
        tree = "Results/{gene}/Trees/tree_no_outgroup.nwk",
        protein_alignment = "Results/{gene}/Alignments/protein_no_outgroup.fasta",
        codon_alignment = "Results/{gene}/Alignments/codon_no_outgroup.fasta",
    params:
        outgroup = config["Outgroup"],
    conda:
        "../environment.yml",
...
rule refine_tree_sequences:
    ...
    """
    input:
        alignment = "Results/{gene}/Alignments/codon_no_outgroup.fasta",
        tree = "Results/{gene}/Trees/tree_no_outgroup.nwk",
...
rule translate_tree_sequences:
    ...
    output:
        ...
        gene_alignments = "Results/{gene}/Augur_AA_Alignements/{gene}.fasta",
    conda:
        "../environment.yml",
    log:
...
rule export_tree:
    ...
    output:
        auspice_tree = "auspice/Herpesvirus-Glycoprotein-Analysis_{gene}.json",
    conda:
        "../environment.yml",
    shell:
        "augur export v2 "
